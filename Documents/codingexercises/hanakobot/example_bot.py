...
- brainstorm more commands
- split bot commands into cogs
- look into cloud servers for bot
- remove test commands""")

@bot.command()
async def test(ctx):
    image = [
        r"C:\Users\avery\Documents\codingexercises\hanakobot\physical_labor.jpg",
        r"C:\Users\avery\Documents\codingexercises\hanakobot\peaceout.jpg"
        ]
...
async def kiss(ctx, member: discord.Member=None):
    ...
    if member == None:
        ...
        kiss_choice = [
            ...
            #f'**"There are many different kinds of threats, Honorable Number 7!" {user} leans in to kiss {receiver} in order to threaten ', (finish this)
...
async def mokke(ctx, member: discord.Member=None):
    ...
    if member == None:
        ...
        image = r"C:\Users\avery\Documents\codingexercises\hanakobot\mokke\mokke_horde.jpg"
